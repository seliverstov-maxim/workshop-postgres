...
Потенциальный ключ - это уникальная колонка или их набор.
...
* ни один неключевой атрибут R не находится в транзитивной функциональной зависимости от потенциального ключа R (это означает, что в отношении отсутствуют какие-либо взаимные зависимости).
